      ...
      if (role === "admin") {
        document
          ...
          .addEventListener("submit", function (event) {
            ...
            const established = (
              document.getElementById("established") as HTMLInputElement
            ).value;
            const singleroom = (
              document.getElementById("singleroom") as HTMLInputElement
            ).value;
            const singleroomrate = (
              document.getElementById("singleroomrate") as HTMLInputElement
            ).value;
            const doubleroom = (
              document.getElementById("doubleroom") as HTMLInputElement
            ).value;
            const doubleroomrate = (
              document.getElementById("doubleroomrate") as HTMLInputElement
            ).value;
            const suite = (document.getElementById("suite") as HTMLInputElement)
              .value;
            const suiterate = (
              document.getElementById("suiterate") as HTMLInputElement
            ).value;
            const website = (
            ...
            const image1 = (
              document.getElementById("image1") as HTMLInputElement | null
            )?.files?.[0];
