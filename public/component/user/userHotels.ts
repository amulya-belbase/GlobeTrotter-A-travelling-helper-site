        ...
        if (response.data.length === 0) {
          ...
          response.data.forEach((item: any) => {
            ...
            bookBtn.addEventListener("click", function () {
              ...
              (
                document.getElementById("bookHotelName") as HTMLInputElement
              ).value = selectedItem.hotelname;
              ...
              document
                ...
                .addEventListener("change", function () {
                  ...
                  (
                    document.getElementById("bookRoomRate") as HTMLInputElement
                  ).value = roomRate();
                });
              ...
              document
                ...
                .addEventListener("submit", function (event) {
                  ...
                  const room_type = (
                    document.getElementById("bookRoomType") as HTMLInputElement
                  ).value;
                  const room_rate = (
                    document.getElementById("bookRoomRate") as HTMLInputElement
                  ).value;
                  const room_count = (
                    document.getElementById("bookRoomCount") as HTMLInputElement
                  ).value;
    ...
    document
      ...
      .addEventListener("submit", function (event) {
        ...
        const locationOption = (
          document.getElementById("location_filter_option") as HTMLInputElement
        ).value;
        const searchOption = (
