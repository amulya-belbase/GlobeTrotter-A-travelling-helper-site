    ...
    if (token) {
      ...
      axios
        ...
        .then((response) => {
          ...
          if (responseCount === 0) {
            (document.getElementById("total_hotel_number") as HTMLElement).textContent = "0";
            console.log("this user doesn't have any data");
          } else {
            (document.getElementById("total_hotel_number") as HTMLElement).textContent = responseCount;
            ...
            const formattedDate = dateObject.toLocaleDateString('ne-NP', options);
              ...
              updateBtn.addEventListener("click", function () {
                ...
                try {
                  ...
                  (document.getElementById("bookHotelName") as HTMLInputElement).value =
                  ...
                  (document.getElementById("bookArrivalDate") as HTMLInputElement).value =
                    formattedDate;
  
                  (document.getElementById("bookRoomCount") as HTMLInputElement).value =
                  ...
                  document
                    ...
                    .addEventListener("change", function () {
                      const selectedRoomType = (this as HTMLInputElement).value;
                      axios
                        .get(
                        ...
                        .then((response) => {
                          ...
                          (document.getElementById("bookRoomRate") as HTMLInputElement).value =
                            roomRate();
                        });
                    });
      ...
      axios
        ...
        .then((response) => {
          ...
          if (responseCount === 0) {
            (document.getElementById("total_flight_number") as HTMLInputElement).textContent = "0";
            console.log("this user doesn't have any data");
          } else {
            const divContainer = document.querySelector(".userFlights");
            (document.getElementById("total_flight_number") as HTMLInputElement).textContent =
              responseCount;
            ...
            const formattedDate = dateObject.toLocaleDateString('ne-NP', options);
              ...
              updateBtn.addEventListener("click", function () {
                ...
                try {
                  ...
                  (document.getElementById("bookFlightName") as HTMLInputElement).value =
                    selectedItem.flightname;
  
                  const departureDate = new Date(selectedItem.departureDate);
                  const formattedDate = departureDate.toISOString().split("T")[0];
                  (document.getElementById("bookDeptDate") as HTMLInputElement).value = formattedDate;
  
                  (document.getElementById("bookSeatCount") as HTMLInputElement).value =
                    ...
                    .addEventListener("change", function () {
                      ...
                      axios
                        ...
                        .then((response) => {
                          ...
                          (document.getElementById("bookSeatRate") as HTMLInputElement).value =
                            roomRate();
                        });
                    });
                  ...
                  updateForm!.addEventListener("submit", function (event) {
                    ...
                    const flightname =
                      (document.getElementById("bookFlightName") as HTMLInputElement).value;
                    const departureDate =
                      (document.getElementById("bookDeptDate") as HTMLInputElement).value;
                    const seat_type =
                      (document.getElementById("bookSeatType") as HTMLInputElement).value;
                    const seat_rate =
                      (document.getElementById("bookSeatRate") as HTMLInputElement).value;
                    const seat_count =
                      (document.getElementById("bookSeatCount") as HTMLInputElement).value;
