...
document.addEventListener("DOMContentLoaded", function () {
    const loginCheck = document.getElementById("userValidationDiv") as HTMLInputElement;
    const loginUser = document.getElementById("userValidation") as HTMLInputElement;
    const loginLink = document.getElementById("loginLink") as HTMLInputElement;
    const loginCheckDiv = document.querySelector(".upper_header_right_login") as HTMLInputElement;
    const userButtons = document.getElementById("userValidationDivDropdown") as HTMLInputElement;
